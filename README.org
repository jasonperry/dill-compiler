...
- Struct and variant types, type aliases
- All concrete types are datatypes; there are no classes (containers
  ...
  call syntax also differentiates mutating from non-mutating methods.
...
- Separate compilation by means of auto-generated module
  ...
  are not part of the language definition proper; a module's behavior is
