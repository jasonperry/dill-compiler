...
%type <(locinfo, locinfo, locinfo typeExpr) stmt> stmt
...
%start <(locinfo, locinfo, locinfo typeExpr) dillmodule> modsource
%start <(locinfo, locinfo, locinfo typeExpr) module_spec> modspec
%%
...
proc:
  | pd=procHeader BEGIN sb=stmtSeq END name2=IDENT_LC
    ...
    { if (pd: (locinfo, locinfo typeExpr) procdecl).name = name2 then
