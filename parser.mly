...
%type <(Ast.locinfo, Ast.locinfo) Ast.procdecl> procHeader
%type <(Ast.locinfo, Ast.locinfo) Ast.procdecl> procDecl
%type <(Ast.locinfo, Ast.locinfo) Ast.proc> proc
%type <(Ast.locinfo, Ast.locinfo) Ast.variantDecl> variantDecl
...
%start <(Ast.locinfo, Ast.locinfo) Ast.module_spec> modspec
%%
...
proc:
  | pd=procHeader BEGIN sb=stmtSeq END name2=IDENT_LC
    (* code generated by Menhir couldn't infer the type of pd. *)
